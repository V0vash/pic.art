...
/* harmony import */ var _modules_addMoreStyles__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/addMoreStyles */ "./src/js/modules/addMoreStyles.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_popups__WEBPACK_IMPORTED_MODULE_0__["default"])();
  ...
  Object(_modules_addMoreStyles__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-styles', '#styles .row');
...
/***/ "./src/js/modules/addMoreStyles.js":
/*!*****************************************!*\
  !*** ./src/js/modules/addMoreStyles.js ***!
  \*****************************************/
/*! exports provided: default */
...
/* harmony import */ var _services_services__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./services/services */ "./src/js/modules/services/services.js");
...
var addMoreStyles = function addMoreStyles(trigger, wrapper) {
  var btn = document.querySelector(trigger);
  btn.addEventListener('click', function () {
    Object(_services_services__WEBPACK_IMPORTED_MODULE_4__["getData"])('http://localhost:3000/styles').then(function (res) {
...
/* harmony default export */ __webpack_exports__["default"] = (addMoreStyles);
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var sum = 0;
  Object(_services_services__WEBPACK_IMPORTED_MODULE_0__["getData"])('../../assets/price.json').then(function (res) {
    return calcFunc(res);
  });
  ...
  function renderOptions(obj, selector) {
    for (var key in obj) {
      ...
      option.innerText = "".concat(key);
      option.setAttribute("value", "".concat(obj[key]));
      option.setAttribute("name", "".concat(key));
...
/* harmony import */ var _services_services__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./services/services */ "./src/js/modules/services/services.js");
...
var drop = function drop() {
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      if (input.closest('.file_upload').classList.contains('upload_fast')) {
        var formData = new FormData();
        formData.append('file', input.files[0]);
        Object(_services_services__WEBPACK_IMPORTED_MODULE_5__["postData"])('assets/server.php', formData).then(function (res) {
...
function forms() {
  ...
  forms.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      Object(_services_services__WEBPACK_IMPORTED_MODULE_8__["postData"])(api, formData).then(function (res) {
        console.log(res);
...
var popups = function popups() {
  ...
  bindPopup('.fixed-gift', '.popup-gift', '.popup-close', true); // showPopupByTime('.popup-consultation', 6000);
...
var sliders = function sliders(slides, direction, next, prev) {
  var SlideIndex = 1,
      paused = false;
